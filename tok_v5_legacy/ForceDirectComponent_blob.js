 ...
 //let colourkeys = groupColorScale.domain( );
  ...
  useEffect(() => { 
    ...
    simulationRef.current = d3
      ...
      .force('center', d3.forceCenter(1000, 900).strength(1))
  ...
  useEffect (() => { 
      ...
      blobPath = childLinkGroup.selectAll('.blobpath').data( d => [d]);
        ...
        // -- for multiple lines -- (a group with lines situtated within) -- //
          ...
          childLinkGroup
              ...
              .tween  ('pathmove', function (d) {   
                    ...
                    let childblob = d3.select(this).select('.blobpath')
  ...
  function drawGroupsSmall( ) { 
      ...
      smallCircle
          ...
          .attr('r', d =>  (Math.max (yearScaleSize(d.date_1), 0))+3)
            .attr ('fill', d => { 
              if (selectedMakers.current[1].makers.map (m => m.id).includes(d.id)) return 'orangered'
  ...
  function forceLayout ( ) { 
      ...
      simulation_parentRef.current.alpha(.1).restart( ); 
...
// -- RETURN -- // 
return (
    <g ref={chartRef} transform="translate(0, 300) scale(0.5)"></g>
